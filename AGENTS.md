...
| [rules/orianbuilder-errors.md](rules/orianbuilder-errors.md)         | Classifying IPC/main errors with `OrianBuilderError` / `OrianBuilderErrorKind` and PostHog exception filtering |
...
| [rules/chat-message-indicators.md](rules/chat-message-indicators.md) | Using `<orianbuilder-status>` tags in chat messages for system indicators                                      |
| [rules/supabase-functions.md](rules/supabase-functions.md)           | Deploying, bundling, or queueing Supabase Edge Functions                                                       |
| [rules/product-principles.md](rules/product-principles.md)           | Planning new features, especially via `orianbuilder:swarm-to-plan`, to guide design trade-offs                 |
...
If you have access to the `/orianbuilder:lint` skill, use it to run all pre-commit checks automatically:
...
- Main-process IPC errors that are **not bugs** (validation, missing entities, auth, user refusal, etc.) should be thrown as **`OrianBuilderError`** with a **`OrianBuilderErrorKind`** so they can be excluded from PostHog exception telemetry. See [rules/orianbuilder-errors.md](rules/orianbuilder-errors.md).
