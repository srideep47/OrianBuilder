...
This document describes the i18n system for Orian Builder. The goal is to support multiple languages across the Electron renderer and main process with type-safe translation keys, minimal boilerplate, and incremental adoption.
...
<Trans i18nKey="home:welcome" t={t}>
  Welcome to <strong>Orian Builder</strong>
</Trans>;
```
