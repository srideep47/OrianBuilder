...
<orianbuilder-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
</orianbuilder-security-finding>

<orianbuilder-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<orianbuilder-security-finding title="SQL Injection in User Lookup" level="critical">
...
<orianbuilder-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<orianbuilder-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<orianbuilder-security-finding title="JWT Secret Using Default Value" level="high">
...
<orianbuilder-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<orianbuilder-security-finding title="Missing Security Headers" level="low">
