...
`;
      ...
      const encodedTitle = encodeURIComponent(
        "[bug] Error in OrianBuilder application",
      );
      const githubIssueUrl = `https://github.com/orianbuilder-sh/orianbuilder/issues/new?title=${encodedTitle}&labels=bug,filed-from-app,client-error&body=${encodedBody}`;
      ...
      ipc.system.openExternalUrl(
        "https://github.com/orianbuilder-sh/orianbuilder/issues/new",
      );
    } finally {
      setIsLoading(false);
    }
