    ...
    >
      ...
      <div className="relative">
        <div
          ...
          className="flex gap-4 overflow-x-auto scrollbar-on-hover pb-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-2xl"
        >
          {featured.map((app) => (
          ...
          {hasMore && (
            <button
              type="button"
              onClick={() => navigate({ to: "/apps" })}
              className="flex flex-col items-center justify-center w-56 aspect-[4/3] flex-shrink-0 rounded-3xl border border-dashed border-border bg-(--background-lighter) hover:border-primary/40 hover:bg-(--background-lightest) transition-all duration-200 active:scale-[0.99]"
            >
