...
export function McpConsentToast({
  ...
  return (
    <div className="relative bg-amber-50/95 dark:bg-slate-800/95 backdrop-blur-sm border border-amber-200 dark:border-slate-600 rounded-3xl shadow-lg min-w-[420px] max-w-[560px] overflow-hidden">
      <div className="p-5">
