...
export function LexicalChatInput({
  ...
  onPaste,
  excludeCurrentApp,
  placeholder = "Ask OrianBuilder to build...",
  disabled = false,
  disableSendButton,
  messageHistory = [],
  inputClassName,
      ...
      <div className="relative flex-1">
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className={cn(
                "flex-1 px-3 pt-3 pb-2 focus:outline-none overflow-y-auto min-h-[44px] max-h-[200px] resize-none text-[15px]",
                inputClassName,
              )}
              ...
              placeholder={
                <div
                  className={cn(
                    "absolute top-3 left-3 text-muted-foreground pointer-events-none select-none text-[15px]",
                    inputClassName,
                  )}
                >
                  {placeholder}
