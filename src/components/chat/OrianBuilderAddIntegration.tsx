...
import { getCompletedIntegrationProvider } from "./orianbuilderAddIntegrationUtils";
import { ipc } from "@/ipc/types";

interface OrianBuilderAddIntegrationProps {
  children: React.ReactNode;
  provider?: "neon" | "supabase";
}

export const OrianBuilderAddIntegration: React.FC<
  OrianBuilderAddIntegrationProps
> = ({ children, provider: requestedProvider }) => {
  ...
  if (completedProvider) {
    return (
      <OrianBuilderCard accentColor="green" state="finished">
        <OrianBuilderCardHeader
          icon={<CheckCircle2 size={15} />}
          accentColor="green"
        >
          <OrianBuilderBadge color="green">
  ...
  return (
    <OrianBuilderCard accentColor="blue">
      <OrianBuilderCardHeader icon={<Database size={15} />} accentColor="blue">
        <OrianBuilderBadge color="blue">
