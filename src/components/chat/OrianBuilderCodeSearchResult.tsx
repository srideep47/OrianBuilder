...
interface OrianBuilderCodeSearchResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const OrianBuilderCodeSearchResult: React.FC<
  OrianBuilderCodeSearchResultProps
> = ({ children }) => {
  ...
  return (
    ...
    >
      <OrianBuilderCardHeader
        ...
        accentColor="indigo"
      >
        <OrianBuilderBadge color="indigo">Code Search Result</OrianBuilderBadge>
        {files.length > 0 && (
