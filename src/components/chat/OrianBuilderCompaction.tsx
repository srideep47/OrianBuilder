...
interface OrianBuilderCompactionProps {
  node: {
    properties: {
      title?: string;
...
export const OrianBuilderCompaction: React.FC<OrianBuilderCompactionProps> = ({
  children,
  node,
}) => {
  ...
  return (
    <div
      className={`relative rounded-2xl border my-2 overflow-hidden transition-colors duration-300 ${
        inProgress
