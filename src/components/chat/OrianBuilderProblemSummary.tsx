...
interface OrianBuilderProblemSummaryProps {
  summary?: string;
...
export const OrianBuilderProblemSummary: React.FC<
  OrianBuilderProblemSummaryProps
> = ({ summary, children }) => {
  ...
  return (
    ...
    >
      <OrianBuilderCardHeader
        ...
        accentColor="amber"
      >
        <OrianBuilderBadge color="amber">Auto-fix</OrianBuilderBadge>
