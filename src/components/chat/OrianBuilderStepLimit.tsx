...
interface OrianBuilderStepLimitProps {
  node: {
    properties: {
      steps?: string;
      limit?: string;
...
export function OrianBuilderStepLimit({
  node,
  children,
}: OrianBuilderStepLimitProps) {
  ...
  return (
    <OrianBuilderCard state={state} accentColor="amber" isExpanded={true}>
      <OrianBuilderCardHeader
      ...
      <OrianBuilderCardContent isExpanded={true}>
        {content && (
