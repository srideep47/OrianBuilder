      ...
      <div className="flex items-start justify-between gap-3">
        ...
        >
          ...
          {product.image_url ? (
            ...
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-md border border-border bg-muted/40 text-muted-foreground">
...
function RatingBadge({
  ...
  return (
    <span
      className="inline-flex items-center gap-1 rounded-md border border-amber-500/40 bg-amber-500/10 px-1.5 py-0.5 text-[11px] text-amber-600 dark:text-amber-300"
      ...
      <div className="grid gap-3 md:grid-cols-[1fr_1fr_auto]">
        ...
        <div className="flex flex-col gap-2 md:items-end">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-2 rounded-md bg-orange-500 px-3 py-1.5 text-xs font-semibold text-white hover:bg-orange-400 transition-colors"
          >
