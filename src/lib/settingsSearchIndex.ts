...
export const SETTING_IDS = {
  ...
  appDataDir: "setting-app-data-dir",
  defaultChatMode: "setting-default-chat-mode",
  defaultMissionAutonomyProfile: "setting-default-mission-autonomy-profile",
...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  },
  {
    ...
    description:
      "Set the top-level folder that OrianBuilder will store new applications in",
    keywords: [
      "customize",
      "apps",
      "path",
  ...
  {
    id: SETTING_IDS.appDataDir,
    label: "App Data & Model Storage",
    description:
      "Choose the drive/folder for the database, settings, and downloaded AI models",
    keywords: [
      "data",
      "models",
      "storage",
  ...
  {
    id: SETTING_IDS.youtube,
    label: "YouTube Integration",
    description: "Connect a YouTube channel to publish generated videos",
    keywords: [
      "youtube",
      "publish",
      "video",
  ...
  },
  {
    ...
    description:
      "Choose how much unattended authority new automated missions receive",
    keywords: [
      "mission",
      "autonomy",
      "autopilot",
