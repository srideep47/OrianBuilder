...
const OFFICIAL: Template[] = [
  {
    ...
    badge: "Official",
    badgeC: "green",
    desc: "Uses React, Vite, Shadcn, Tailwind & TypeScript.",
    sel: true,
  },
  {
    icon: "▲",
    ...
    badge: "Official",
    badgeC: "green",
    desc: "Uses Next.js, React, Shadcn, Tailwind & TypeScript.",
  },
];
...
const COMMUNITY: Template[] = [
  {
    icon: "🛍",
    name: "Portal · Mini Store",
    badge: "Experimental",
    badgeC: "amber",
    desc: "Uses Neon DB, Payload CMS, Next.js",
  },
  {
    icon: "⚡",
    name: "SvelteKit",
    badge: "Official",
    badgeC: "green",
    desc: "SvelteKit · TypeScript · Tailwind · file-based routing.",
  },
  {
    icon: "⚛",
    ...
    badge: "Official",
    badgeC: "green",
    desc: "Start from scratch with a blank React setup.",
  },
  {
    icon: "⬡",
    name: "Blank Vue App",
    badge: "Official",
    badgeC: "green",
    desc: "Start from scratch with a blank Vue setup.",
  },
];
    ...
    <div className={`glass tpl ${t.sel ? "sel" : ""}`}>
      ...
      <div className="tpl-info">
        ...
        {t.sel ? (
          ...
          <a style={{ fontSize: 12, color: "#a88cff", cursor: "pointer" }}>
            View on GitHub →
          </a>
        )}
      </div>
...
export function HubPage() {
  ...
  return (
    <div className="hub-page">
      ...
      <h1 className="hub-title" style={{ marginTop: 6 }}>
