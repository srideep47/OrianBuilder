...
const ALLOWED_EXTENSIONS = [
  ...
  ".swift",
  // Edge cases
  // https://github.com/orianbuilder-sh/orianbuilder/issues/880
  ".py",
  // https://github.com/orianbuilder-sh/orianbuilder/issues/1221
  ".php",
];
...
//
// ex: https://github.com/orianbuilder-sh/orianbuilder/issues/727
const EXCLUDED_DIRS = [
  "node_modules",
  ".git",
  "dist",
...
async function formatFile({
  ...
  try {
    ...
    if (!shouldReadFileContents({ filePath, normalizedRelativePath })) {
      return `<orianbuilder-file path="${normalizedRelativePath}">
