(function () {
  console.debug("orianbuilder-shim.js loaded via proxy v0.6.0");
      ...
      if (url && typeof url === "string") {
        try {
          ...
          if (
            ...
            console.warn(
              "[orianbuilder-shim] Blocked navigation to unsafe URL protocol:",
              parsedUrl.protocol,
            );
          }
        } catch (e) {
          console.error("[orianbuilder-shim] Invalid navigation URL:", e);
        }
      } else if (url) {
        console.warn("[orianbuilder-shim] Invalid URL type:", typeof url);
      } else {
